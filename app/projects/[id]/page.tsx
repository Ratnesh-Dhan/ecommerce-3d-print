        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-between items-start mb-12">
          <div>
            <div className="flex flex-wrap items-center gap-3 mb-3">
              ...
              <span className={`text-xs px-3 py-1 rounded-full font-bold ${project.status === "Completed"
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between bg-zinc-950/60 p-4 rounded-xl border border-zinc-900">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold border transition ${activeMedia === "image"
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold border transition ${activeMedia === "video"
                    ? "bg-yellow-500 text-black border-yellow-500"
                    : "border-zinc-800 text-gray-400 hover:text-white hover:border-zinc-700"
                    }`}
                >
              ...
              <div className="flex gap-2 overflow-x-auto max-w-full">
                {project.images.map((img, idx) => (
                  <button
                    ...
                    className={`w-12 h-12 rounded-lg overflow-hidden border-2 shrink-0 transition ${activeMedia === "image" && selectedImageIndex === idx
        ...
        <div className="border border-yellow-500/10 rounded-2xl overflow-hidden bg-zinc-950/80 mb-16">
          ...
          <div className="flex border-b border-zinc-900 bg-zinc-950">
            <button
              ...
              className={`px-6 py-4 text-sm font-bold transition flex items-center gap-2 border-b-2 ${activeTab === "firmware"
            ...
            <button
              ...
              className={`px-6 py-4 text-sm font-bold transition flex items-center gap-2 border-b-2 ${activeTab === "schematics"
                ? "border-yellow-500 text-yellow-500 bg-black/40"
                : "border-transparent text-gray-500 hover:text-white"
                }`}
            >
